package de.itemis.fluffyj.tests.exceptions;

import static de.itemis.fluffyj.tests.FluffyTestHelper.assertIsStaticHelper;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_CHECKED_EXCEPTION;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_ERROR;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_ERROR_MESSAGE;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_MESSAGE;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_THROWABLE;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_THROWABLE_MESSAGE;
import static de.itemis.fluffyj.tests.exceptions.ExpectedExceptions.EXPECTED_UNCHECKED_EXCEPTION;
